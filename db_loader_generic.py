...
if __name__ == "__main__":
    add_personal_info("John Smith", "john.smith@email.com", "555-555-5555",
                      "linkedin.com/in/john-smith", "github.com/john-smith", None)
    ...
    add_publication(1, "Creating Cool Stuff.", "smith, J", 2024, "Cool Stuff", "2024(3)", "126–221")
