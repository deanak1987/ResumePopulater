...
def populate_resume(person_id, template_path="template.docx", output_file="Resume.docx"):
    ...
    for para in doc.paragraphs:
        if "{education}" in para.text:
            ...
            original_font = para.runs[0].font if para.runs else None  # Save font details
